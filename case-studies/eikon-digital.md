...
> operational substrate" — and, precisely because it is that ambitious, it is the most clearly labeled
> estimate here.

## Total cost of ownership

This is the flagship TCO argument. With ~350k hand-authored lines, ~179 routes, 132 tables, and 71
integrations, Eikon carries the heaviest lifetime-maintenance load of the four — and the
...
The wager is not that the rebuild is cheap — it is that a governed tenant is **an order of magnitude
cheaper to *own* over its life** than ~350k lines of hand-authored operational code. (Exact line counts
