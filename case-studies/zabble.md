...
**Status: Planned conversion. The "after" is a projected target that has not shipped. Figures are labeled
estimates.**
...
- **Projected ratio:** ~30-40% reasoning / ~60-70% code _(estimate)_. A meaningful shift, short of a full
  rewrite, and deliberately short of the 90 : 10 target.
