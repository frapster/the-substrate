...
**Does NOT prove / is NOT:** this is a **generic gate primitive**, not the BOSNet.io engine
or kernel. It is not a full governance runtime; the rules here (`KNOWN_SOURCE_IDS`,
`MAX_AMOUNT_USD`) are invented toy policy, not a real schema or spec. The proprietary
...
*admissibility*, not *quality of intent*: a proposal can pass every check here and still be
