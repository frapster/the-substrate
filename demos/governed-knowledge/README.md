...
**Governed knowledge wins on currency and provenance, not on a rigged retriever.**
...
**Does NOT prove / is NOT:** this is a **generic retrieval-ranking primitive**, not
BOSNet.io's knowledge model, evidence schema, or coordinate scheme — those are
...
property legible, not the output of a real embedding model. It is not a full
