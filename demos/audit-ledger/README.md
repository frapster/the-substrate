...
Real, measured numbers. This benchmarks the ledger primitive's integrity and
...
**Does NOT prove / is NOT:** this is a **generic cryptographic primitive**, distinct from
the BOSNet.io engine. It is not a full governance runtime; it does not police what a model
