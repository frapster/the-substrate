...
- **This is one small, illustrative feature; it does not measure a whole system.** It is
...
- **The branch/fact symmetry here (3 new cases → 3 new branches → 3 new facts) is a property
  of this toy feature; it does not generalize as a law.** Real features vary: some new requirements cost several
  branches per case (nested conditionals) or several facts (compound conditions); the point
  demonstrated is *where the cost lands* (code vs. data). The ratio itself is not fixed.
