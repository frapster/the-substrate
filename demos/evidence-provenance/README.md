...
That last moment, two claims sharing one source and both **detaching the instant the
...
Real, measured numbers. This benchmarks the evidence primitive's
...
**Does NOT prove / is NOT:** this is a **generic hashing/pinning primitive**, distinct
from the BOSNet.io evidence model. It is not a full knowledge substrate: it does not do
...
[`../../LICENSE.md`](../../LICENSE.md). Detecting that a source moved does not reveal
*which* of two conflicting sources is now true; that's a reconciliation
